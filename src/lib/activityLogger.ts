...
export const ActivityAction = {
  ...
  B2B_CUSTOMER_RECORDS_CLEARED: 'B2B_CUSTOMER_RECORDS_CLEARED',
  ...
  B2C_CUSTOMER_RECORDS_CLEARED: 'B2C_CUSTOMER_RECORDS_CLEARED',
  ...
  OFFICE_EXPENSE_UPDATED: 'OFFICE_EXPENSE_UPDATED',
  PERSONAL_EXPENSE_CREATED: 'PERSONAL_EXPENSE_CREATED',
  PERSONAL_EXPENSE_UPDATED: 'PERSONAL_EXPENSE_UPDATED',
  ...
  VENDOR_RECORDS_CLEARED: 'VENDOR_RECORDS_CLEARED',
  VENDOR_PURCHASE_CREATED: 'VENDOR_PURCHASE_CREATED',
  VENDOR_PURCHASE_UNDONE: 'VENDOR_PURCHASE_UNDONE',
  VENDOR_PAYMENT_RECORDED: 'VENDOR_PAYMENT_RECORDED',
  VENDOR_PAYMENT_DELETED: 'VENDOR_PAYMENT_DELETED',
  VENDOR_CREDIT_APPLIED: 'VENDOR_CREDIT_APPLIED',
  VENDOR_ITEM_CREATED: 'VENDOR_ITEM_CREATED',
  VENDOR_ITEM_UPDATED: 'VENDOR_ITEM_UPDATED',
  VENDOR_ITEM_DELETED: 'VENDOR_ITEM_DELETED',
} as const;
