        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're here to help with all your LPG requirements and questions
            </p>
          </motion.div>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <p className="text-xl text-red-700 mb-8">
              For urgent LPG-related emergencies, contact our 24/7 emergency response team
            </p>
