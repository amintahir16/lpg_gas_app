...
export default function B2CCustomerDetailPage() {
  ...
  const handleDownloadReport = async () => {
    ...
    try {
      ...
      await downloadPdfBlob(blob, `B2C-Transaction-Report-${customer.name}-${new Date().toISOString().split('T')[0]}.pdf`);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-sm font-bold text-gray-900">
                  {customer.marginCategory ? customer.marginCategory.name : 'All Homes'}
                </p>
              </div>
            </div>
          </CardContent>
